...
def main():
    url = input("Digite a URL do site de citações (ou pressione Enter para usar 'https://quotes.toscrape.com/'): ")
    url = url.strip() or 'https://quotes.toscrape.com/'  # Usar a URL padrão se nenhum URL for fornecido
